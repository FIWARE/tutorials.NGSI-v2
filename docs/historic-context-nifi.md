...
[![Run in GitPod](https://fiware.github.io/tutorials.NGSI-LD/img/gitpod.png)](https://gitpod.io/#https://github.com/FIWARE/tutorials.Historic-Context-NIFI/tree/NGSI-v2)
...
[![](https://fiware.github.io/tutorials.NGSI-LD/img/video-logo.png)](https://www.youtube.com/watch?v=_uLZDGFPlRA&list=PLR9elAI9JscTyBVUq0P48OMVkrbdPitB7&index=42&t=1767s 'NGSI-v2 Draco')

Click on the image above to watch a demo of this tutorial persisting context data using Apache NIFI
