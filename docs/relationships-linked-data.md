...
[![Run in GitPod](https://fiware.github.io/tutorials.NGSI-LD/img/gitpod.png)](https://gitpod.io/#https://github.com/FIWARE/tutorials.Relationships-Linked-Data/tree/NGSI-v2)
...
`fiware:Building` which expands to `https://uri.fiware.org/ns/datamodels%23Building`. It is therefore possible to
